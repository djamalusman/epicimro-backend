...
class TestimonialsController extends Controller
{
    ...
    public function getDropdownTestimoni() {
    ...
    public function getViewStoreTestimonial($id)
    {
        $data['menus'] = MenuModel::find(39);
        $data['title']      = 'Video';
        $data['title_page'] = 'Pelatihan / Kursus | ' . $data['menus']->menu_name;
        ...
        return view('pages.testimonial_store', $data);
    }
    ...
    public function storeTestimoniUpdate(Request $req)
    {
        ...
        try {
            ...
            $this->validate($req, [
                ...
                $listItem->save();
                //video
                if (!is_null($req->embedvideo)) {
                    foreach ($req->embedvideo as $embedvideo) {
                        $dataembedvideo = new TestimonialsDetailModel();
                        $dataembedvideo->id_testimoni = $listItem->id;
                        $dataembedvideo->url = $embedvideo;
    ...
    public function getVieweditTestimoni($id)
    {
        $data['menus'] = MenuModel::find(39);
        $data['title']      = 'Video';
        $data['title_page'] = 'Pelatihan / Kursus | ' . $data['menus']->menu_name;
