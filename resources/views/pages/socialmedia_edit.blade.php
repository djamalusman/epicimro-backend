                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" id="idcategory" name="idcategory">
                                                    ...
                                                    @foreach ($liscategory as $value)
                                                            <option value="{{ $value->id }}" <?= ($value->id == $datasm->id_category) ? 'selected' : '' ?>>{{ $value->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    <input type="text" class="form-control embedvideo" placeholder="" name="urlsm" value="{{$datasm->url}}" >
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="modal-contentPhoto">
                                    <img src="{{ asset('/') }}storage/{{ $datasm->file ?? '' }}" alt="Preview Image" class="img-thumbnail" width="250px">
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function submitFormWithStatus(status) {
                ...
                $.ajax({
                    url: '/public/update-social-media',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
