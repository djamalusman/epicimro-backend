                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-0">
                                              ...
                                              <a type="button" href="{{ route('get-view-store-gallery',  ['id' => base64_encode($menus->id)])}}" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                                              </a>
                                        </div>
                                        <div class="col-1">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="titleSelect">Nama Image</label>
...
function formatDate(dateStr) {
    ...
    $(document).ready(function() {
        ...
        function loadDropdownData() {
            $.ajax({
                url: '/public/get-filters-gallery', // URL endpoint to fetch data
                type: 'GET',
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        var viewimage=`<span type="button" class="badge badge-primary"  onclick="parsingDataToModal('${value.id}')">View image</span>`;
                        table.row.add([
                            key + 1,
                                value.nama,
                                value.category,
                                    ...
                                    <div class="row">
                                        <div class="ml-auto d-flex">
                                            ...
                                            <div class="col text-right mb-3">
                                                <a type="button" style="color:Green" href="/public/edit-gallery/${btoa(value.id)}/${btoa(value.id_category)}" title="Edit Gallery">
                                                    <i class="fa fa-bars"></i>
                                                </a>
                                            </div>
                                            <div class="col text-right mb-3">
                                                <a type="button" href="#" style="color:red" onclick="removeGallery('${value.id}')" title="Delete Gallery">
    ...
    function parsingDataToModal(id) {
        ...
        var url = "{{ route('view-image-gallery',':id') }}";
    ...
    function removeGallery(id) {
        var url = "{{ route('delete-data-gallery',':id') }}";
        url = url.replace(":id", id);
