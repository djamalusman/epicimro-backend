...
$(document).ready(function() {
    ...
    function loadDropdownData() {
        $.ajax({
            url: '/public/get-filters-social-media', // URL endpoint to fetch data
            type: 'GET',
                                ...
                                <div class="row">
                                    <div class="ml-auto d-flex">
                                        <div class="col text-right mb-3">
                                            <a type="button" style="color:Green" href="/public/edit-social-media/${btoa(value.id)}" title="Edit Course">
