                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @if ($banner < 1)
                                        <div class="row">
                                                  <div class="col-0">
                                                  <a type="button" href="{{ route('get-view-store-banner',  ['id' => base64_encode($menus->id)])}}" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                                                  </a>
                                                  </div>
                                                  <div class="col-1">
...
function formatDate(dateStr) {
    ...
    $(document).ready(function() {
        ...
        function loadDropdownData() {
            $.ajax({
                url: '/public/get-filters-banner', // URL endpoint to fetch data
                type: 'GET',
