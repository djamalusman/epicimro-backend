                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-1"> </div>
                                            <div class="col-md-5">  
                                                <input type="text" class="form-control" value="{{ $databyid->nama }}" id="nama_training" name="nama">
                                            </div>
                                        </div>
...
<script>
    ...
    function removeDataPhoto(button) {
        ...
        if (inputId) {
            ...
            $.ajax({
                url: '/public/remove-photo-gallery/' + inputId, // Ganti dengan endpoint API Anda
                type: 'GET',
