                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="iddtl" id="iddtl" value="{{$iddtl }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-1"> </div>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" value="{{ $databyid->id_category == '30' ? $databyid->nama : ""}}" id="nama_testimoni"
                                                        name="nama_testimoni">
                                                </div>
                                            </div>
                                            <!-- Menu -->
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control embedvideo" placeholder=""
                                                            name="embedvideo[]" value="{{ $databyid->id_category == '30' ? $databyid->url : ""}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-1"> </div>
                                                <div class="col-md-9">
                                                    <textarea id="w3review"  name="description" id="description" rows="4" cols="120"><?php echo $databyid->description ?></textarea>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function submitFormWithStatus(status) {
                ...
                $.ajax({
                    url: '/public/update-testimonials',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
