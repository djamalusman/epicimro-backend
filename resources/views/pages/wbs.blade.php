...
<div class="content-wrapper">
    <section class="content p-4">
        ...
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('store-whistleblowing-system') }}" enctype="multipart/form-data" id="store-whistleblowing-system-form">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button type="button" onclick="validatePrompt('store-whistleblowing-system-form')" class="btn btn-danger start"> Save </button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <section class="content p-4">
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('store-whistleblowing-system-list') }}" enctype="multipart/form-data" id="store-whistleblowing-system-form-list">
                    @csrf
                    <input type="hidden" name="idSP" value="{{base64_encode($dataContent->id ?? '') }}">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button type="button" onclick="validatePrompt('store-whistleblowing-system-form-list')" class="btn btn-danger start"> Add </button>
                        </div>
                    </div>
                </form>
                                        ...
                                        <table id="side-list-visi-misi" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('/') }}storage/{{ $dm->file ?? '' }}" alt="simulasi" class="img-thumbnail simulasi-gambar-picture-visi-misi" width="140px"></td>
                                                    <td>
...
<script>
    ...
    function parsingDataToModal(id) {
        ...
        var url = "{{ route('edit-list-detail-wbs',':id') }}";
