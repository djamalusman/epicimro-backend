                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select id="companyNameSelect" class="form-control">
    ...
    function loadDropdownData() {
        $.ajax({
            ...
            success: function(data) {
                ...
                companyNameSelect.empty(); // Clear existing items
                ...
                companyNameSelect.append('<option value="">All</option>');
                ...
                $.each(data, function(key, value) {
                    uniqueCompanyNames.add(value.company_name);
                ...
                appendUniqueItems(uniqueCompanyNames, companyNameSelect);
