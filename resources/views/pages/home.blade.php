...
<div class="content-wrapper">
    <section class="content p-4">
        ...
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('store-home') }}" enctype="multipart/form-data" id="company-form">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="picture-sekilas-perusahaan">Update Background Header</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="logo-sekilas-perusahaan">Update Logo</label>
                                        <div class="input-group">
                                            <div class="custom-file">
                            ...
                            <div class="row">
                                <div class="col-md-6" hidden>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="side_list" class="form-control" value="-" id="side_list1" placeholder="{{explode('|',$title_page)[1]}}" value="{{$dataTk->side_list ?? ''}}">
                                ...
                                <div class="col-md-6" hidden>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="side_list_en" class="form-control" value="-" id="side_list_en1" placeholder="{{explode('|',$title_page)[1]}}" value="{{$dataTk->side_list_en ?? ''}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="titleEn">Video Footer</label>
