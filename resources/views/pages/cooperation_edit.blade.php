            ...
            <section class="content p-4 col-md-12" >
                <div class="card card-default">
                    <div class="card-header bg-red">
                        <h3 class="card-title">Edit Cooperation</h3>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" value="{{ $databyid->nama}}" id="companyName" name="companyName">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <input type="text" class="col-md-2 form-control" readonly value="Website Company">
                                                <div class="col-md-1"> </div>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="urlcompanyName"value="{{ $databyid->url}}" name="urlcompanyName">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="modal-contentPhoto">
                                <img src="https://admin.trainingkerja.com/public/storage/{{ $databyid->file}}" alt="Preview Image" class="img-thumbnail" width="250px">
                            </div>
