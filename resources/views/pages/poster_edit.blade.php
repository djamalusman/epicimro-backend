    ...
    <section class="content p-4 col-md-12" >
        <div class="card card-default">
            <div class="card-header bg-red">
                <h3 class="card-title">Edit Poster</h3>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        {{-- <div class="form-group row">
                                            ...
                                            <div class="col-md-1"> </div>
                                            <div class="col-md-5">
                                                <select class="form-control" id="menutesti" name="menu">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-1"> </div>
                                            <div class="col-md-5">  
                                                <input type="text" class="form-control" value="{{ $databyid->nama }}" id="nama" name="nama">
                                            </div>
                                        </div>
                                        ...
                                        @if (Count($listmateri) > 0)
                                            @foreach ($listfiles as $index => $datphoto)
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="photoDb{{ $index }}" readonly value="{{ $datphoto->file }}" name="photoData[]" data-iddphoto="{{ $datphoto->id }}">
                                                            <div class="input-group-append">
                                                                <button type="button" class="btn btn-primary btn-preview" data-index="{{ $index }}" onclick="previewPhoto(this)">View file</button>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 offset-md-3">
                                                <button type="button" id="preview-btn" class="btn btn-info" hidden>Preview</button>
...
<script>
    ...
    function previewPhoto(button) {
        ...
        if (photoInput) {
            ...
            // Pastikan URL gambar sesuai dengan path yang benar
            var imagePath = `{{ asset('storage') }}/${photoName}`;

            $('#modal-contentPhoto').html(`
                <img src="${imagePath}" alt="Preview Image" class="img-thumbnail" width="250px">
            `);
    ...
    function removeDataPhoto(button) {
        ...
        if (inputId) {
            ...
            $.ajax({
                url: '/public/remove-photo-poster/' + inputId, // Ganti dengan endpoint API Anda
                type: 'GET',
