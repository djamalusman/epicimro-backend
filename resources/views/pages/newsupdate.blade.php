                                ...
                                <div class="row">
                                    <div class="ml-auto d-flex">
                                        <div class="col text-right mb-3">
                                            <a type="button" style="color:Green" href="/public/edit-newsupdate/${btoa(value.id)}" title="Edit News">
                                                <i class="fa fa-bars"></i>
                                            </a>
                                        </div>
                                        <div class="col text-right mb-3">
                                            <a type="button" href="#" style="color:red" onclick="removeNews('${value.id}')" title="Delete News">
