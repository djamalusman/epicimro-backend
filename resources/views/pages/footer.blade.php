...
<div class="content-wrapper">
    ...
    <section class="content p-4">
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('store-footer') }}" enctype="multipart/form-data" id="laporan-tahunan-form-list">
                    @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type">
                                            ...
                                            <option value="ikuti-kami">Ikuti Kami</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" name="item_file" class="custom-file-input" id="footer">
                                                <label class="custom-file-label" for="customFile">Choose file</label>
                                            </div>
                                        </div>
                                        ...
                                        <small id="item_file_error" class="item_file_error input-group text-sm mt-2 text-danger error"></small>
                                        <div class="mt-2">
                                            <img src="" alt="simulasi" class="img-thumbnail simulasi-gambar-footer" width="140px">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="table-responsive">
                                        <table id="rekrutmen-tbl" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td><img src="{{ asset('/') }}storage/{{ $dm->file ?? '' }}" alt="simulasi" class="img-thumbnail" width="140px"></td>
...
<script>
    ...
    function parsingDataToModal(id) {
        ...
        var url = "{{ route('edit-list-detail-footer',':id') }}";
