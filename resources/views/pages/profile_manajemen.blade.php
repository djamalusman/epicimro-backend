                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="picture">Update Background Header Direksi</label>
                                    ...
                                    <div class="form-group">
                                        <label for="picture">Update Background Header Komisaris</label>
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" name="item_file_2" class="custom-file-input" id="picture-visi-misi-komisaris">
                                                <label class="custom-file-label" for="customFile">Choose file</label>
                                            </div>
                                        </div>
                                        <small id="picture-anggota-holding_info" class="input-group text-sm mt-2 error">File type: jpeg, png, jpg | Max Size: 100 Mb {{ $dataItem->item_file_2 ?? '' }}</small>
                                        <small id="item_file_2_error" class="item_file_2_error input-group text-sm mt-2 text-danger error"></small>
                                        <div class="mt-2">
                                            <img src="{{ asset('/') }}storage/{{ $dataItem->item_file_2 ?? '' }}" alt="simulasi" class="img-thumbnail simulasi-gambar-picture-visi-misi-komisaris" width="140px">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <table id="side-list-visi-misi" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" href="{{ route('edit-profile-manajemen',  ['id' => base64_encode($dm->id)])}}" class="btn btn-warning">Edit</a>
