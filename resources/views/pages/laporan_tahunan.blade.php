...
<div class="content-wrapper">
    <section class="content p-4">
        ...
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('store-laporan-tahunan') }}" enctype="multipart/form-data" id="laporan-tahunan-form">
                    @csrf
    ...
    <section class="content p-4">
        <div class="card card-default">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('store-laporan-tahunan-list') }}" enctype="multipart/form-data" id="laporan-tahunan-form-list">
                    @csrf
                    <input type="hidden" name="idSP" value="{{base64_encode($dataContent->id ?? '') }}">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" name="item_file_2" class="custom-file-input" id="cover-file">
                                                <label class="custom-file-label" for="customFile">Choose file</label>
                                            </div>
                                        </div>
                                        <small id="picture-anggota-holding_info" class="input-group text-sm mt-2 error">File type: jpeg, png, jpg, pdf | Max Size: 100 Mb</small>
                                        ...
                                        <div class="mt-2">
                                            <img src="" alt="simulasi" class="img-thumbnail simulasi-gambar-cover-file" width="140px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table id="side-list-visi-misi" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>{{ $dm->title }}</td>
                                                    <td>{{ $dm->date_report }}</td>
                                                    <td><embed src="{{ asset('/') }}storage/{{ $dm->file ?? '' }}" width="400px" height="200px" /></td>
                                                    <td>
...
<script>
    ...
    function deletePrompt(id) {
        var url = "{{ route('delete-laporan-tahunan-list',':id') }}";
        url = url.replace(":id", id);
